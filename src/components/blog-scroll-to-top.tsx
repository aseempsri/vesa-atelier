...
export function BlogScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-6 z-50 flex items-center gap-2 rounded-full border px-4 py-3 transition-all duration-300 hover:opacity-90 md:bottom-10 md:right-10"
      style={{
