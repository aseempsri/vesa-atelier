...
// Generated by scripts/generate-og-image.py; the filename carries a revision because social
// platforms cache link previews per image URL.
export const DEFAULT_OG_IMAGE = `${SITE_URL}/og/vesa-atelier-4.jpg`;
